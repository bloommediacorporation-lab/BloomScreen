...
if (typeof window !== 'undefined') {
  window.electronAPI = {
    ...
    selectSource: async (source) => source,
    ...
    getCursorTelemetry: async () => {
      ...
      for (let timeMs = 0; timeMs < durationMs; timeMs += 30) {
        ...
        if (isDwell) {
          ...
          const newCx = currentSample.cx + (cx - currentSample.cx) * moveSpeed * dt;
          const newCy = currentSample.cy + (cy - currentSample.cy) * moveSpeed * dt;
