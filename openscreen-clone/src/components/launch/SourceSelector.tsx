		...
		return (
			...
			>
				<div className="text-center">
					<div className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#5D5FEF] mx-auto mb-2" />
		...
		<div className={`min-h-screen flex flex-col ${styles.glassContainer}`}>
			...
			<div className="p-3 flex justify-center gap-2">
				...
				<Button
					...
					className="px-5 py-1 text-xs bg-[#5D5FEF] text-white hover:bg-[#5D5FEF]/80 disabled:opacity-30 disabled:bg-zinc-700 rounded-full"
				>
					{tc("actions.share")}
				</Button>
			</div>
