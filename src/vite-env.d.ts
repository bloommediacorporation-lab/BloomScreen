...
interface Window {
	electronAPI: {
		...
		hudOverlayHide: () => Promise<void>;
		hudOverlayClose: () => Promise<void>;
		revealInFolder: (path: string) => Promise<{ success: boolean; error?: string; message?: string }>;
		getShortcuts: () => Promise<any>;
		saveShortcuts: (shortcuts: any) => Promise<void>;
		readBinaryFile: (
			path: string,
		) => Promise<{ success: boolean; data?: Uint8Array; error?: string; message?: string; path?: string }>;
