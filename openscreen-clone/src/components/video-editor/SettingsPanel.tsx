		...
		<div className="flex-[2] min-w-0 bg-[#09090b] border border-white/5 rounded-2xl flex flex-col shadow-xl h-full overflow-hidden">
			<div className="flex-1 overflow-y-auto custom-scrollbar p-4 pb-0">
					...
					<div className="flex items-center justify-between mb-3">
						...
						<div className="flex items-center gap-2">
							{zoomEnabled && selectedZoomDepth && (
								<span className="text-[10px] uppercase tracking-wider font-medium text-[#5D5FEF] bg-[#5D5FEF]/10 px-2 py-0.5 rounded-full">
							...
							return (
								<Button
									...
									className={cn(
										...
										isActive
											? "border-[#5D5FEF] bg-[#5D5FEF] text-white shadow-[#5D5FEF]/20"
				...
				>
							...
							<div className="grid grid-cols-2 gap-2 mb-3">
								<div className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
									...
									<Switch
										...
										className="data-[state=checked]:bg-[#5D5FEF] scale-90"
									/>
								</div>
							</div>
							...
							<div className="grid grid-cols-2 gap-2">
								<div className="p-2 rounded-lg bg-white/5 border border-white/5">
									...
									<Slider
										...
										max={1}
										step={0.01}
										className="w-full [&_[role=slider]]:bg-[#5D5FEF] [&_[role=slider]]:border-[#5D5FEF] [&_[role=slider]]:h-3 [&_[role=slider]]:w-3"
									/>
								</div>
								<div className="p-2 rounded-lg bg-white/5 border border-white/5">
									<div className="flex items-center justify-between mb-1">
					...
					>
						<AccordionTrigger className="py-2.5 hover:no-underline">
							<div className="flex items-center gap-2">
								<Palette className="w-4 h-4 text-[#5D5FEF]" />
						...
						<AccordionContent className="pb-3">
							<Tabs defaultValue="image" className="w-full">
								<TabsList className="mb-2 bg-white/5 border border-white/5 p-0.5 w-full grid grid-cols-3 rounded-lg">
									<TabsTrigger
										value="image"
										className="data-[state=active]:bg-[#5D5FEF] data-[state=active]:text-white text-slate-400 text-[10px] py-1 rounded-md transition-all"
									>
										{t("background.image")}
									</TabsTrigger>
									<TabsTrigger
								...
								<div className="max-h-[min(200px,25vh)] overflow-y-auto custom-scrollbar">
									<TabsContent value="image" className="mt-0 space-y-2">
										...
										<Button
											...
											variant="outline"
											className="w-full gap-2 bg-white/5 text-slate-200 border-white/10 hover:bg-[#5D5FEF] hover:text-white hover:border-[#5D5FEF] transition-all h-7 text-[10px]"
										>
												...
												return (
													<div
														...
														className={cn(
															...
															isSelected
																? "border-[#5D5FEF] ring-1 ring-[#5D5FEF]/30"
																: "border-white/10 hover:border-[#5D5FEF]/40 opacity-80 hover:opacity-100 bg-white/5",
														)}
														style={{
								...
								{[
									...
									<div key={field} className="flex flex-col gap-1">
										...
										<input
											...
											className="w-[90px] h-8 rounded-md border border-white/10 bg-white/5 px-2 text-xs text-slate-200 outline-none focus:border-[#5D5FEF]/50 focus:ring-1 focus:ring-[#5D5FEF]/30 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
										/>
									</div>
								))}
								...
								<div className="flex flex-col gap-1">
									...
									<div className="flex items-center gap-1.5">
										<select
											...
											className="h-8 rounded-md border border-white/10 bg-[#1a1a1f] px-2 text-xs text-slate-200 outline-none focus:border-[#5D5FEF]/50 cursor-pointer"
										>
										...
										<button
											...
											className={cn(
												...
												cropAspectLocked
													? "border-[#5D5FEF]/50 bg-[#5D5FEF]/10 text-[#5D5FEF]"
			...
			<div className="flex-shrink-0 p-4 pt-3 border-t border-white/5 bg-[#09090b]">
				<div className="flex items-center gap-2 mb-3">
					<button
						...
						className={cn(
							...
							exportFormat === "mp4"
								? "bg-[#5D5FEF]/10 border-[#5D5FEF]/50 text-white"
						...
						<div className="flex items-center justify-between">
							...
							<div className="flex items-center gap-2">
								...
								<Switch
									...
									className="data-[state=checked]:bg-[#5D5FEF] scale-75"
								/>
							</div>
						</div>
					</div>
				...
				<Button
					...
					size="lg"
					onClick={onExport}
					className="w-full py-5 text-sm font-semibold flex items-center justify-center gap-2 bg-[#5D5FEF] text-white rounded-xl shadow-lg shadow-[#5D5FEF]/20 hover:bg-[#5D5FEF]/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
				>
					<Download className="w-4 h-4" />
				...
				<div className="flex gap-2 mt-3">
					...
					>
						<Bug className="w-3 h-3 text-[#5D5FEF]" />
						{t("links.reportBug")}
					</button>
					<button
						type="button"
