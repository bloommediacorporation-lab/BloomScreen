			...
			<div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[60] bg-[#09090b] rounded-2xl shadow-2xl border border-white/10 p-8 w-[90vw] max-w-md animate-in zoom-in-95 duration-200">
				<div className="flex items-center justify-between mb-6">
					<div className="flex items-center gap-4">
						{showSuccess ? (
							<>
								<div className="w-12 h-12 rounded-full bg-[#5D5FEF]/20 flex items-center justify-center ring-1 ring-[#5D5FEF]/50">
						...
						<div className="space-y-2">
							...
							<div className="h-2 bg-white/5 rounded-full overflow-hidden border border-white/5">
								{isCompiling || isFinalizing ? (
									...
									renderProgress !== undefined && renderProgress > 0 ? (
										<div
											className="h-full bg-[#5D5FEF] shadow-[0_0_10px_rgba(93, 95, 239,0.3)] transition-all duration-300 ease-out"
											style={{ width: `${renderProgress}%` }}
										/>
									) : (
										<div className="h-full w-full relative overflow-hidden">
											<div
												className="absolute h-full w-1/3 bg-[#5D5FEF] shadow-[0_0_10px_rgba(93, 95, 239,0.3)]"
												style={{
